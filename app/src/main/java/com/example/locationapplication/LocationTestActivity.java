...
public class LocationTestActivity extends Activity {
    ...
    private TextView location_gaode;
    ...
    private void initView() {
        ...
        location_gaode = (TextView) findViewById(R.id.location_gaode);
    ...
    private void initLocation() {
        LocationUtils.getInstance(LocationTestActivity.this).initLocation(new LocationHelper() {
            ...
            public void UpdateLocation(Location location) {
                ...
                Gps gcj = PositionUtil.gps84_To_Gcj02(location.getLatitude(), location.getLongitude());
                location_gaode.setText(gcj.toString());

                String address = LocationUtils.getAddress(location.getLatitude(), location.getLongitude());
                location_detail.setText(address == null ? "未获取" : address);
            }
